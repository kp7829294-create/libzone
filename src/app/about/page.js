      ...
      <main className="pt-32 pb-20 px-4 md:px-8">
        <div className="max-w-4xl mx-auto space-y-20">
          <div className="text-center space-y-6">
            ...
            <h1 className="font-display font-black text-4xl sm:text-5xl md:text-7xl text-slate-900 tracking-tight leading-tight">
              Making Knowledge <br />
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              <h2 className="font-display font-bold text-2xl sm:text-3xl text-slate-900">Who We Are</h2>
